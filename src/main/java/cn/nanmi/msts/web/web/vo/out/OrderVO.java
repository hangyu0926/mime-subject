...
public class OrderVO {
    ...
    public OrderVO(OrderDTO orderDTO) {
        ...
        this.stockAmt = orderDTO.getStockAmt();
        ...
        this.maxBiddingPrice = orderDTO.getMaxBiddingPrice();
        this.maxBidder = orderDTO.getMaxBidder();
        this.createTime = orderDTO.getCreateTime();
        this.saleTime = orderDTO.getSaleTime();
        this.expireTime = orderDTO.getExpireTime();
        this.systemRuleId = orderDTO.getSystemRuleId();
    }
